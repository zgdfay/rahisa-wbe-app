...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-2xl bg-white/40 p-1 text-muted-foreground backdrop-blur-md",
      className
    )}
    {...props}
  />
